 ...
 */
package org.prometheus.cryptographic_processor.aes;

import org.prometheus.cryptographic_processor.pgp.*;
 ...
 */
public class AESProcessorException extends CryptographicProcessorException{


    /**
     * General constructor.
     */
    public AESProcessorException() {
        super();
    }
     ...
     */
    public AESProcessorException(final String message) {
        super(message);
    }
     ...
     */
    public AESProcessorException(final Throwable cause) {
        super(cause);
    }
